...
const influencer = {
  ...
  infHeroSub: 'We match your brand with the right creators, write briefs that actually convert, and run the whole campaign to a number that matters — enquiries, orders and revenue, not just views.',
  ...
  infStep2Title: 'Build campaigns that convert', infStep2Body: 'Hooks, briefs, scripts, offers and landing pages built to move product. We can also run the best posts as ads, so a winner keeps selling.',
  infStep3Title: 'Deliver real brand impact', infStep3Body: 'Tracking links, promo codes and a live dashboard tie every creator to enquiries and orders — so you know exactly what worked and what to scale.',
  ...
  infGet3Title: 'Turning posts into ads', infGet3Body: "Running the best creator posts as ads from the creator's own handle, to reach more people.",
  infGet4Title: 'Tracking & reporting', infGet4Body: 'Promo codes, tracking links and a dashboard from first view to sale.',
