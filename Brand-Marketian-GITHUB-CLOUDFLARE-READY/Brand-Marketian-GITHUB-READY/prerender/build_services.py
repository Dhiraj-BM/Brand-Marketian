...
def _nav_item(nav, href, on):
    i = nav.index(f'<a href="{href}" class="scp0"'); j = nav.index("</a>", i)
    seg = nav[i:j]
...
NAV = NAV.replace('<a href="/blog" class="scp0" style="position: relative; flex: 0 0 auto; padding: 8px 10px; border-radius: 999px; color: var(--color-accent-700); font-weight: 700;',
                  '<a href="/blog" class="scp0" style="position: relative; flex: 0 0 auto; padding: 8px 10px; border-radius: 999px; color: var(--color-text); font-weight: 500;')
NAV = NAV.replace('<a href="/services" class="scp0" style="position: relative; flex: 0 0 auto; padding: 8px 10px; border-radius: 999px; color: var(--color-text); font-weight: 500;',
                  '<a href="/services" class="scp0" style="position: relative; flex: 0 0 auto; padding: 8px 10px; border-radius: 999px; color: var(--color-accent-700); font-weight: 700;')
